...
namespace Tests
{
    public class LogicTests
    {
        ...
        public void GetAllOiTest()
        {
            ...
            Assert.True(Math.Abs(node1.P.Estimation + 99.764) < 0.1, "Ќекорректный расчет Pi по U");
            Assert.True(Math.Abs(node1.Q.Estimation + 49.88205) < 0.1, "Ќекорректный расчет Qi по U");

            Assert.True(Math.Abs(branch1.Pj.Estimation - 112.227) < 0.1, "Ќекорректный расчет Pij по U");
            Assert.True(Math.Abs(branch1.Qj.Estimation - 62.345) < 0.1, "Ќекорректный расчет Qij по U");
            Assert.True(Math.Abs(branch1.Ij.Estimation * 1000 - 644.528) < 0.1, "Ќекорректный расчет Iij по U");
        }
        ...
        public void GetOiLineTest()
        {
            ...
            Assert.True(Math.Abs(node1.P.Estimation + 99.731) < 0.1, "Ќекорректный расчет Pi по U");
            Assert.True(Math.Abs(node1.Q.Estimation + 49.866) < 0.1, "Ќекорректный расчет Qi по U");

            Assert.True(Math.Abs(branch1.Pj.Estimation - 123.116) < 0.1, "Ќекорректный расчет Pij по U");
            Assert.True(Math.Abs(branch1.Qj.Estimation - 77.846) < 0.1, "Ќекорректный расчет Qij по U");
            Assert.True(Math.Abs(branch1.Ij.Estimation * 1000 - 731.29) < 0.1, "Ќекорректный расчет Iij по U");
        }
        ...
        public void SimpleKalman2D()
        {
            ...
            // «адаем начальные значение State и Covariance
            kalman.SetState(x, p);
